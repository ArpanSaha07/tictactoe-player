...
class TicTacToe():
    def __init__(self):
        self.board = self.make_board()      # we will use single list to rep. 3x3 board
...
def play(game, x_player, o_player, print_game=True):    #returns the winner of the game, or None for a tie
